...
from bias_manager_helper import predict_and_explain
...
def search():
    ...
    for result in results:
        if output_format == 'html':
            ...
            if int(request.form.get('searchmode', 0)) > 0:
                if '—' in content:
    ...
    return render(
        ...
        current_bias = request.form.get('bias'),
        searchmode = request.form.get('searchmode', -1),
